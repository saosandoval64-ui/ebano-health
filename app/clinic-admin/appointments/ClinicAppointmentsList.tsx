...
export default function ClinicAppointmentsList({ initialAppointments }: ClinicAppointmentsListProps) {
    ...
    <div className="space-y-6">
      ...
      {appointments.length === 0 ? (
        <div className="p-12 border border-dashed border-gray-200 rounded-2xl text-center bg-gray-50">
          ...
          <p className="text-sm font-medium text-black/40">No hay turnos registrados para tu clínica.</p>
        </div>
      ) : (
